...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  String _selected   = 'pro'; // current active plan
  ...
  Future<void> _selectPlan(_Plan plan) async {
    ...
    // If already pending payment for this plan, go back to payment screen
    if (_pendingId == plan.id) return;

    final isUpgrade = _plans.indexWhere((p) => p.id == plan.id) >
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Your ${_plans.firstWhere((p) => p.id == _pendingId).name} plan payment is being reviewed. It will activate automatically once confirmed by our billing team.',
                                style: GoogleFonts.inter(
                                    fontSize: 12,
                                    color: warningText,
                                    height: 1.4),
                      ...
                      children: [
                        ...[
                          ...
                          ('Apr 2026', 'Pro Plan', 'Rs. 2,500', true),
                              ...
                              if (i < 2)
                                const Divider(
                                    height: 1, indent: 42, color: borderColor),
                            ])),
                      ],
                    ),
                  ),
...
// Dart 3 extension for indexed map
