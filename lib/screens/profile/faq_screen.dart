...
class _FaqScreenState extends State<FaqScreen> {
  ...
  static const _faqs = [
    _FaqItem(
      ...
      a: 'Go to a wholesaler\'s detail page and tap "Browse Stock". Select the products and quantities you need, then tap "Add to Order". Review your order and confirm. The wholesaler will receive your request and approve or modify it.',
    ),
    _FaqItem(
      category: 'Orders',
      icon: Icons.receipt_long_rounded,
    ...
    _FaqItem(
      ...
      a: 'EasyStock supports EasyPaisa, JazzCash, and direct bank transfer. After a wholesaler approves your order, go to the payment screen to see their account details. Make the transfer and share your screenshot via WhatsApp.',
    ),
    _FaqItem(
      category: 'Payments',
      icon: Icons.payments_rounded,
      color: Color(0xFF1A8A5A),
      q: 'How does the wholesaler confirm my payment?',
      a: 'After you share your payment screenshot on WhatsApp, the wholesaler reviews it and confirms receipt. Once confirmed, your order status automatically updates to "Payment Confirmed" and then moves to "Out for Delivery".',
    ),
    _FaqItem(
      category: 'Payments',
      icon: Icons.payments_rounded,
      ...
      a: 'If the wholesaler hasn\'t confirmed after 24 hours, use the "Call Wholesaler" button on the order tracking screen to follow up. You can also reach out via WhatsApp to the same number you sent the screenshot to.',
    ),
    _FaqItem(
      category: 'Wholesalers',
      icon: Icons.store_rounded,
      color: Color(0xFF6C5CE7),
      q: 'How do I connect with a new wholesaler?',
      a: 'Go to the Wholesalers tab and select "Discover". Browse the list and tap on a wholesaler to view their details. Tap "Send Connect Request" to send a connection request. Once approved, you can browse their stock and place orders.',
    ),
    _FaqItem(
      category: 'Wholesalers',
      icon: Icons.store_rounded,
      ...
      a: 'Most wholesalers respond within 1-2 business days. You\'ll receive a notification when your request is approved. You can also call the wholesaler directly to expedite the process.',
    ),
    _FaqItem(
      category: 'Account',
